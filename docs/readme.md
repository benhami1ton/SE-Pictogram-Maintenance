...
os.chdir(os.path.expanduser("~/Downloads/SE-Pictogram-Maintenance-0.7/CSV/"))
...
with open('SE-Pictogram-Maintenance-0.7.csv', 'r') as csv_file:
...
os.chdir(os.path.expanduser("~/Downloads/SE-Pictogram-Maintenance-0.7/EPS/"))
...
def runascript():
	ascript = """
		tell application "System Events"
			...
			delay 0.5
			keystroke "~/Downloads/SE-Pictogram-Maintenance-0.7/EPS/Import/"
			delay 2
			keystroke return
...
os.chdir(os.path.expanduser("~/Downloads/SE-Pictogram-Maintenance-0.7/"))
